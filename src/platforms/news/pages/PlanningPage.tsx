...
export const PlanningPage = () => {
    ...
    const autoSaveToDatabase = async (platformProgramsToSave: Program[]) => {
        setSaveStatus('saving');
        try {
            // CRITICAL: Merge with programs from OTHER platforms before saving
            // Without this, savePrograms would delete all programs from other platforms!
            const otherPlatformPrograms = programs.filter(p => p.systemPlatform !== currentSystemPlatform);
            const allPrograms = [...otherPlatformPrograms, ...platformProgramsToSave];
            await savePrograms(allPrograms);
            setSaveStatus('saved');
