                        ...
                        <div className="space-y-3">
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div>
                                    ...
                                    <input type="text" value={newProgramTitleAr} onChange={(e) => setNewProgramTitleAr(e.target.value)} className="w-full px-3 py-2.5 border border-slate-200 rounded-lg focus:outline-none focus:border-[#00E1C1] text-sm" placeholder="مثال: حملة ا��ربع الأول 2026" />
                                </div>
                            </div>
                            <div className="grid grid-cols-2 gap-3">
                                <div>
